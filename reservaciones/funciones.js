        ...
        switch (t) {
            case 1: //
                $(".mensaje-alerta").append(
                    "<div class='alert alert-success' role='alert'>Se agrego con exito la reservación</div>"
                );
                break;
            case 2: //
                $(".mensaje-alerta").append(
                    "<div class='alert alert-danger' role='alert'>Se elimino la reservación</div>"
                );
                break;
            default:
...
if (dbVacas.length !== 0) {
    ...
    $("#dbVacas-list").append("<h2> No tienes reservas </h2>");
}
...
function contarVacas(){
    ...
    $("#numeroVacas").append(
        "<a>Tienes actualmente" + "<br>" + "<span class='badge'>" + nVacas + "</span></a> Reservas."
    );
    return nVacas;
}
